...
![水锤分析概念图](assets/ch10/concept_water_hammer.png)
...
![本章概念图：有压流瞬态与水锤](assets/ch10/concept_water_hammer_transient.png)
## 2 教材理论
...
当水锤负压波传播时，某些位置的压力水头可能降至负值。在实际物理条件下，当绝对压力降至水的饱和蒸气压（约 $-10\ \mathrm{m}$ 水柱，相对于大气压）以下时，水会发生汽化，形成蒸汽空腔（液柱分离）。当后续正压波到达并压缩蒸汽空腔时，会产生剧烈的**断流弥合水锤**（Column Separation and Rejoining），其升压值可能远超 Joukowsky 值。
...
[8] 赵振兴, 何建京, 王忖. 水力学[M]. 3版. 北京: 清华大学出版社, 2021.
